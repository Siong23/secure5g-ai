...
├── 📁 datasets/
│   │
│   ├── 📦 raw_csv.zip                     # Raw network flow data (Step 4 output from Argus)
│   │   ├── benign_flow.csv
│   │   ├── icmpflood_flow.csv
│   │   ├── synflood_flow.csv
│   │   ├── udpflood_flow.csv
...
│   │   └── fuzzing_flow.csv
│   │
│   ├── 📦 computed_features.zip           # Computed features using Jupyter Notebook (Step 5)
│   │   ├── benign_computed.csv
...
│   │
│   ├── 📦 raw_traffic.zip                 # Original captured traffic (pcapng files before Argus)
│   │   ├── benign.pcapng
│   │   ├── icmpflood.pcapng
│   │   ├── synflood.pcapng
│   │   ├── udpflood.pcapng
...
│   │   └── fuzzing.pcapng
│   │
│   └── 📦 5G_Anomaly_Dataset.zip          # Final merged dataset (all attacks + benign)
│       └── 5G_Anomaly_Dataset.csv
│
├── 📁 python_script/
│   └──  feature_computation.py      # Jupyter Notebook used for feature computation
│
└── 📁 images/
    ├── step1_capture.png
